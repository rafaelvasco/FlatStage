// Credits: https://github.com/FaronBracy/RogueSharp
...
/// <summary>
/// A class implementing IRandom used for generating pseudo-random numbers 
/// using a PCG Based Random Generator;
/// </summary>
public class DefaultRandomGenerator : IRandomGenerator
{
    ...
    /// </summary>
    public DefaultRandomGenerator() : this(Environment.TickCount)
    {
    }
