...
public class WeightedPool<T>
{
    ...
    public WeightedPool(IRandomGenerator random, Func<T, T>? cloneFunc = null)
    {
        _random = random ??
                  throw new ArgumentNullException(nameof(random), "Implementation of IRandom must not be null");
