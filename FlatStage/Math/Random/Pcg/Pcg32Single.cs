...
/// </summary>
internal sealed class Pcg32Single
{
    /// <summary>
    ...
    public uint GenerateNext()
    {
        ...
        var oldState = _state;
        Step();
        return PcgHelpers.OutputXshRr(oldState);
    }
    ...
    public void Advance(ulong delta)
    {
        ...
        _state = PcgHelpers.Advance(_state, delta, PcgHelpers.Multiplier64, PcgHelpers.Increment64);
    }

    private void Step()
    {
        // implements pcg_oneseq_64_step_r
        _state = unchecked(_state * PcgHelpers.Multiplier64 + PcgHelpers.Increment64);
    }
