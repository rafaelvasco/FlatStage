...
public struct Vec2 : IEquatable<Vec2>
{
    ...
    private static Vec2 zeroVector = new(0f, 0f);
    private static Vec2 unitVector = new(1f, 1f);
    private static Vec2 unitXVector = new(1f, 0f);
    private static Vec2 unitYVector = new(0f, 1f);
