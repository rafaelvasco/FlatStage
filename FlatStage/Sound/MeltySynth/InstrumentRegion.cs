...
#pragma warning disable CS1591 // I'm too lazy to add comments for all the following things.
    ...
    public int StartAddressOffset =>
        32768 * this[GeneratorType.StartAddressCoarseOffset] + this[GeneratorType.StartAddressOffset];

    public int EndAddressOffset =>
        32768 * this[GeneratorType.EndAddressCoarseOffset] + this[GeneratorType.EndAddressOffset];

    public int StartLoopAddressOffset => 32768 * this[GeneratorType.StartLoopAddressCoarseOffset] +
                                         this[GeneratorType.StartLoopAddressOffset];

    public int EndLoopAddressOffset => 32768 * this[GeneratorType.EndLoopAddressCoarseOffset] +
    ...
    public float InitialFilterCutoffFrequency =>
        SoundFontMath.CentsToHertz(this[GeneratorType.InitialFilterCutoffFrequency]);
    ...
    public float DelayModulationEnvelope =>
        SoundFontMath.TimecentsToSeconds(this[GeneratorType.DelayModulationEnvelope]);

    public float AttackModulationEnvelope =>
        SoundFontMath.TimecentsToSeconds(this[GeneratorType.AttackModulationEnvelope]);
    ...
    public float DecayModulationEnvelope =>
        SoundFontMath.TimecentsToSeconds(this[GeneratorType.DecayModulationEnvelope]);
    ...
    public float ReleaseModulationEnvelope =>
        SoundFontMath.TimecentsToSeconds(this[GeneratorType.ReleaseModulationEnvelope]);
    ...
    public LoopMode SampleModes => this[GeneratorType.SampleModes] != 2
        ? (LoopMode)this[GeneratorType.SampleModes]
        : LoopMode.NoLoop;

    public int ScaleTuning => this[GeneratorType.ScaleTuning];
    public int ExclusiveClass => this[GeneratorType.ExclusiveClass];

    public int RootKey => this[GeneratorType.OverridingRootKey] != -1
