#pragma warning disable CS8603, CS8625, CS0162
...
namespace FlatStage.Foundation.SDL2;
...
public static class SDL
{
    ...
    public static unsafe IntPtr SDL_CreateShapedWindow(string title, uint x, uint y, uint w, uint h,
        SDL_WindowFlags flags)
    {
    ...
    public struct SDL_WindowShapeParams
    {
        ...
        [FieldOffset(0)] public SDL_Color colorKey;
    }
...
#pragma warning restore 0169
     ...
     * Only available in 2.0.18 or higher.
     */
    [DllImport(nativeLibName, EntryPoint = "SDL_GameControllerGetAppleSFSymbolsNameForButton",
        CallingConvention = CallingConvention.Cdecl)]
...
#pragma warning restore CS8603, CS8625, CS0162