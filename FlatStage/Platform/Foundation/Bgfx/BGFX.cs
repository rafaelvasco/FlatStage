...
internal static class Bgfx
{
    ...
    public static extern unsafe void vertex_convert(VertexLayout* _dstLayout, void* _dstData, VertexLayout* _srcLayout,
        void* _srcData, uint _num);
    ...
    public static extern unsafe void topology_sort_tri_list(TopologySort _sort, void* _dst, uint _dstSize, float _dir,
        float _pos, void* _vertices, uint _stride, void* _indices, uint _numIndices, bool _index32);
    ...
    public static extern unsafe void reset(uint _width, uint _height, uint _flags,
    ...
    public static extern unsafe void dbg_text_image(ushort _x, ushort _y, ushort _width, ushort _height, void* _data,
        ushort _pitch);
    ...
    public static extern unsafe DynamicVertexBufferHandle create_dynamic_vertex_buffer(uint _num, VertexLayout* _layout,
        ushort _flags);
    ...
    public static extern unsafe void update_dynamic_vertex_buffer(DynamicVertexBufferHandle _handle, uint _startVertex,
        Memory* _mem);
    ...
    public static extern unsafe ProgramHandle
        create_program(ShaderHandle _vsh, ShaderHandle _fsh, bool _destroyShaders);
    ...
    public static extern unsafe void calc_texture_size(TextureInfo* _info, ushort _width, ushort _height, ushort _depth,
        bool _cubeMap, bool _hasMips, ushort _numLayers, TextureFormat _format);
    ...
    public static extern unsafe TextureHandle
        create_texture(Memory* _mem, ulong _flags, byte _skip, TextureInfo* _info);
    ...
    public static extern unsafe void update_texture_cube(TextureHandle _handle, ushort _layer, byte _side, byte _mip,
        ushort _x, ushort _y, ushort _width, ushort _height, Memory* _mem, ushort _pitch);
    ...
    [DllImport(DllName, EntryPoint = "bgfx_create_frame_buffer_from_handles",
        CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe FrameBufferHandle create_frame_buffer_from_handles(byte _num, TextureHandle* _handles,
    ...
    public static extern unsafe void
        encoder_set_marker(Encoder* _this, [MarshalAs(UnmanagedType.LPStr)] string _marker);
    ...
    [DllImport(DllName, EntryPoint = "bgfx_encoder_set_dynamic_index_buffer",
        CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void encoder_set_dynamic_index_buffer(Encoder* _this, DynamicIndexBufferHandle _handle,
        uint _firstIndex, uint _numIndices);
    ...
    public static extern unsafe void encoder_set_vertex_buffer(Encoder* _this, byte _stream, VertexBufferHandle _handle,
    ...
    [DllImport(DllName, EntryPoint = "bgfx_encoder_submit_occlusion_query",
        CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void encoder_submit_occlusion_query(Encoder* _this, ushort _id, ProgramHandle _program,
    ...
    public static extern unsafe void encoder_submit_indirect(Encoder* _this, ushort _id, ProgramHandle _program,
        IndirectBufferHandle _indirectHandle, ushort _start, ushort _num, uint _depth, byte _flags);
    ...
    public static extern unsafe void encoder_submit_indirect_count(Encoder* _this, ushort _id, ProgramHandle _program,
        IndirectBufferHandle _indirectHandle, ushort _start, IndexBufferHandle _numHandle, uint _numIndex,
        ushort _numMax, uint _depth, byte _flags);
    ...
    public static extern unsafe void encoder_set_image(Encoder* _this, byte _stage, TextureHandle _handle, byte _mip,
        Access _access, TextureFormat _format);
    ...
    public static extern unsafe void encoder_dispatch(Encoder* _this, ushort _id, ProgramHandle _program, uint _numX,
        uint _numY, uint _numZ, byte _flags);
    ...
    public static extern unsafe void encoder_dispatch_indirect(Encoder* _this, ushort _id, ProgramHandle _program,
        IndirectBufferHandle _indirectHandle, ushort _start, ushort _num, byte _flags);
    ...
    public static extern unsafe UIntPtr override_internal_texture(TextureHandle _handle, ushort _width, ushort _height,
        byte _numMips, TextureFormat _format, ulong _flags);
    ...
    [DllImport(DllName, EntryPoint = "bgfx_set_transient_vertex_buffer_with_layout",
        CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void set_transient_vertex_buffer_with_layout(byte _stream, TransientVertexBuffer* _tvb,
        uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
    ...
    [DllImport(DllName, EntryPoint = "bgfx_set_instance_data_from_vertex_buffer",
        CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void set_instance_data_from_vertex_buffer(VertexBufferHandle _handle, uint _startVertex,
        uint _num);
    ...
    [DllImport(DllName, EntryPoint = "bgfx_set_compute_dynamic_vertex_buffer",
        CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void set_compute_dynamic_vertex_buffer(byte _stage, DynamicVertexBufferHandle _handle,
        Access _access);
