...
class ForwardOnlyPacketProvider : DataPacket, IForwardOnlyPacketProvider
{
    ...
    private bool ReadNextPage(out byte[] pageBuf, out bool isResync, out int dataStart, out int packetIndex,
    ...
    long Contracts.IPacketProvider.SeekTo(long granulePos, int preRoll, GetPacketGranuleCount getPacketGranuleCount) =>
