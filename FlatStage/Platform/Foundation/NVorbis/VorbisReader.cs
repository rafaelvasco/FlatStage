...
public sealed class VorbisReader : IVorbisReader
{
    ...
    internal static Func<Contracts.IPacketProvider, IStreamDecoder> CreateStreamDecoder { get; set; } =
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
    ...
    public string[] Comments =>
        _streamDecoder.Tags.All.SelectMany(k => k.Value, (kvp, Item) => $"{kvp.Key}={Item}").ToArray();
