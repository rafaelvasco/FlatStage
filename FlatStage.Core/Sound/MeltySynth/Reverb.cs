...
internal sealed class Reverb
{
    ...
    internal Reverb(int sampleRate)
    {
        cfsL = new CombFilter[]
        {
            new(ScaleTuning(sampleRate, cfTuningL1)),
            new(ScaleTuning(sampleRate, cfTuningL2)),
            new(ScaleTuning(sampleRate, cfTuningL3)),
            new(ScaleTuning(sampleRate, cfTuningL4)),
            new(ScaleTuning(sampleRate, cfTuningL5)),
            new(ScaleTuning(sampleRate, cfTuningL6)),
            new(ScaleTuning(sampleRate, cfTuningL7)),
            new(ScaleTuning(sampleRate, cfTuningL8))
        };

        cfsR = new CombFilter[]
        {
            new(ScaleTuning(sampleRate, cfTuningR1)),
            new(ScaleTuning(sampleRate, cfTuningR2)),
            new(ScaleTuning(sampleRate, cfTuningR3)),
            new(ScaleTuning(sampleRate, cfTuningR4)),
            new(ScaleTuning(sampleRate, cfTuningR5)),
            new(ScaleTuning(sampleRate, cfTuningR6)),
            new(ScaleTuning(sampleRate, cfTuningR7)),
            new(ScaleTuning(sampleRate, cfTuningR8))
        };

        apfsL = new AllPassFilter[]
        {
            new(ScaleTuning(sampleRate, apfTuningL1)),
            new(ScaleTuning(sampleRate, apfTuningL2)),
            new(ScaleTuning(sampleRate, apfTuningL3)),
            new(ScaleTuning(sampleRate, apfTuningL4))
        };

        apfsR = new AllPassFilter[]
        {
            new(ScaleTuning(sampleRate, apfTuningR1)),
            new(ScaleTuning(sampleRate, apfTuningR2)),
            new(ScaleTuning(sampleRate, apfTuningR3)),
            new(ScaleTuning(sampleRate, apfTuningR4))
        };
    ...
    {
        get { return (roomSize - offsetRoom) / scaleRoom; }
