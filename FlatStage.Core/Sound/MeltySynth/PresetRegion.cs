...
public sealed class PresetRegion
{
    ...
    {
        return
            $"{instrument.Name} (Key: {KeyRangeStart}-{KeyRangeEnd}, Velocity: {VelocityRangeStart}-{VelocityRangeEnd})";
    }
...
#pragma warning disable CS1591 // I'm too lazy to add comments for all the following things.
    ...
    public float InitialFilterCutoffFrequency =>
        SoundFontMath.CentsToMultiplyingFactor(this[GeneratorType.InitialFilterCutoffFrequency]);
    ...
    public int ModulationEnvelopeToFilterCutoffFrequency =>
    ...
    public float FrequencyModulationLfo =>
        SoundFontMath.CentsToMultiplyingFactor(this[GeneratorType.FrequencyModulationLfo]);
    ...
    public float DelayModulationEnvelope =>
        SoundFontMath.CentsToMultiplyingFactor(this[GeneratorType.DelayModulationEnvelope]);

    public float AttackModulationEnvelope =>
        SoundFontMath.CentsToMultiplyingFactor(this[GeneratorType.AttackModulationEnvelope]);

    public float HoldModulationEnvelope =>
        SoundFontMath.CentsToMultiplyingFactor(this[GeneratorType.HoldModulationEnvelope]);

    public float DecayModulationEnvelope =>
        SoundFontMath.CentsToMultiplyingFactor(this[GeneratorType.DecayModulationEnvelope]);

    public float SustainModulationEnvelope => 0.1F * this[GeneratorType.SustainModulationEnvelope];

    public float ReleaseModulationEnvelope =>
        SoundFontMath.CentsToMultiplyingFactor(this[GeneratorType.ReleaseModulationEnvelope]);
    ...
    public float AttackVolumeEnvelope =>
        SoundFontMath.CentsToMultiplyingFactor(this[GeneratorType.AttackVolumeEnvelope]);
    ...
    public float ReleaseVolumeEnvelope =>
        SoundFontMath.CentsToMultiplyingFactor(this[GeneratorType.ReleaseVolumeEnvelope]);
