...
public struct Rect : IEquatable<Rect>
{
    ...
    )
    {
        ...
        {
            int rightSide = MathUtils.Min(
                value1.X + value1.Width,
                value2.X + value2.Width
            );
            int leftSide = MathUtils.Max(value1.X, value2.X);
            int topSide = MathUtils.Max(value1.Y, value2.Y);
            int bottomSide = MathUtils.Min(
    ...
    {
        int x = MathUtils.Min(value1.X, value2.X);
        int y = MathUtils.Min(value1.Y, value2.Y);
        return new Rect(
            x,
            y,
