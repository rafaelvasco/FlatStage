    ...
    where TKey : IEquatable<TKey>
{
    ...
    private static readonly Entry s_emptyEntry = new Entry() { Next = -1, Key = default! };
    ...
    public TValue this[TKey key]
    {
        ...
        get
        {
            ...
            if (found)
                return value;
            FlatException.Throw("Index not found");
            return default!;
        }
    ...
    private void Grow()
    {
        ...
        FlatException.Assert(m_count == m_entries.Length);
        FlatException.Assert(MathUtils.IsPowerOfTwo(newSize));
    ...
    public void Validate()
    {
        ...
        FlatException.Assert(count == m_count);
    }

    public void CopyKeys(Span<TKey> target)
    {
        FlatException.Assert(target.Length >= m_count);
    ...
    public ValuesEnumerator Values => new(this);
