...
{
    public readonly Vec2 Left => _left;

    public readonly Vec2 Right => _right;
...
public static class Gamepad
{
    ...
    private static GamePadState[] _gpState = new GamePadState[MaxCount];
    private static GamePadState[] _lastGpState = new GamePadState[MaxCount];
