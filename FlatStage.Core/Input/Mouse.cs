...
{
    public static event MouseButtonEventHandler? OnMouseDown;
    public static event MouseButtonEventHandler? OnMouseUp;
    public static event MouseMoveEventHandler? OnMouseMove;
    public static event MouseMoveEventHandler? OnMouseEntered;
    public static event MouseMoveEventHandler? OnMouseExited;
    ...
    internal static void Init()
    {
        ...
        Platform.WindowEntered = () =>
        {
            OnMouseEntered?.Invoke(MousePos.X, MousePos.Y);
        };

        Platform.WindowExited = () =>
        {
