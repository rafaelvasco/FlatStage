...
namespace FlatStage.Foundation.Stb;
...
internal static unsafe partial class StbRectPack
{
    public struct stbrp_context : IDisposable
    {
        ...
        public stbrp_context(int nodesCount)
        {
            ...
            // Allocate nodes
            all_nodes = (stbrp_node*)CRuntime.Malloc((ulong)(sizeof(stbrp_node) * nodesCount));

            // Allocate extras
            extra = (stbrp_node*)CRuntime.Malloc((ulong)(sizeof(stbrp_node) * 2));
        }
